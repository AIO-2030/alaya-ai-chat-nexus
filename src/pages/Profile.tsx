...
const Profile = () => {
  ...
  // Solana wallet state (for account info display only; connect logic is in WalletConnectPanel)
      ...
      <div className={pageBaseStyles.page__base}>
        ...
        <div className={styles.profile__account__info}>
          <div className={styles.profile__account__card}>
            ...
            {/* Wallet connection & Start to Earn (shared WalletConnectPanel) */}
            <div className={styles.profile__wallet__section}>
              <WalletConnectPanel
                variant="full"
                onNavigateToTaskRewards={() => navigate({ pathname: '/task-rewards', search: location.search })}
              />
            </div>
